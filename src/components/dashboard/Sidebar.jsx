...
import { LayoutDashboard, Briefcase, Users, GraduationCap, Calendar, Settings, LogOut, ChevronsLeft, ChevronsRight } from 'lucide-react'
...
const navItems = [
  ...
  { to: '/dashboard/cursos', icon: GraduationCap, label: 'Cursos' },
